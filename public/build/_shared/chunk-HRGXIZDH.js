...
var require_moment = __commonJS({
  "node_modules/moment/moment.js"(exports, module) {
    (function(global, factory) {
      ...
      function createDate(y, m2, d2, h2, M, s, ms) {
        var date;
        if (y < 100 && y >= 0) {
          date = new Date(y + 400, m2, d2, h2, M, s, ms);
          if (isFinite(date.getFullYear())) {
            date.setFullYear(y);
          }
        } else {
          date = new Date(y, m2, d2, h2, M, s, ms);
        }
        return date;
      }
...
// empty-module:~/utils/blog.server
var require_blog = __commonJS({
  "empty-module:~/utils/blog.server"(exports, module) {
    module.exports = {};
  }
});
...
// node_modules/reading-time-estimator/dist/reading-time-estimator.js
var i = {
...
var h = (e) => (e.match(/[\w|\d|\s|,|.|\u00C0-\u024F|\u4E00-\u9FA5|\u3041-\u309F]+/giu) ?? []).flatMap((s) => s.match(/[\u4E00-\u9FA5]/gu) ?? s);
var L = (e) => h(e).reduce((t, s) => t + (s.trim().length ? s.trim().split(/\s+/u).length : 0), 0);
var k = (e) => e < 1 + Number.EPSILON;
var b = (e, t = "en") => g[t][e ? "less" : "default"];
var F = (e, t = 300, s = "en") => {
  const u = L(e), n = Math.round(u / t), a = k(n);
  return {
    minutes: n,
    words: u,
    text: `${a ? "" : `${n} `}${b(a, s)}`
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/blog-card.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1706339852654.223";
}
function Card({
  post
}) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: `/blog/${data.slug}`, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("article", { className: "flex flex-col gap-2 drop-shadow-xl max-w-[20rem] mx-auto", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "min-h-[50%] w-full rounded-md p-1 hover:border-4 duration-300 hover:border-blue-500", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: data.photo, alt: data.title, className: "w-full min-h-full rounded-md object-cover" }, void 0, false, {
      fileName: "app/components/blog-card.tsx",
      lineNumber: 38,
      columnNumber: 11
    }, this) }, void 0, false, {
      fileName: "app/components/blog-card.tsx",
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-col gap-2 p-2", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-slate-500 text-lg dark:text-slate-400", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-wrap gap-2", children: data.tags.split(",").map((tag, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "rounded-xl bg-stone-500 p-1 text-xs text-white", children: tag }, `${tag}-${index}`, false, {
        fileName: "app/components/blog-card.tsx",
        lineNumber: 47,
        columnNumber: 55
      }, this)) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", { className: "text-lg p-2 capitalize my-auto", children: data.title }, void 0, false, {
      fileName: "app/components/blog-card.tsx",
      lineNumber: 52,
      columnNumber: 9
    }, this)
...
_c = Card;
var BlogCard = import_react.default.memo(Card);
_c2 = BlogCard;
var _c;
var _c2;
$RefreshReg$(_c, "Card");
...
// app/components/empty-content-ui.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/empty-content-ui.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1706197091920.3716";
}
function EmptyContentUI({
  message,
  className
}) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("h2", { className: cn("text-4xl capitalize text-slate-400 font-black py-8 flex flex-col items-center justify-center", className), children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(FiAlertCircle, { className: cn("inline mr-2 text-[7rem] text-slate-300 mb-4", className) }, void 0, false, {
      fileName: "app/components/empty-content-ui.tsx",
      lineNumber: 28,
      columnNumber: 7
    }, this),
    " ",
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("span", { children: message }, void 0, false, {
      fileName: "app/components/empty-content-ui.tsx",
      lineNumber: 29,
      columnNumber: 7
    }, this)
...
moment/moment.js:
  ...
  (*! momentjs.com *)
*/
//# sourceMappingURL=/build/_shared/chunk-HRGXIZDH.js.map
