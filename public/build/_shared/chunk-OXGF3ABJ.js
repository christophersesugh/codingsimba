...
var Reveal = (props) => {
  ...
  return /* @__PURE__ */ jsx2(Fragment3, { children: import_react4.Children.map(children, (node2, index) => {
      ...
      case "ul":
        return /* @__PURE__ */ jsx2(ClassNames, { children: ({ cx }) => /* @__PURE__ */ jsx2(
          node2.type,
          {
            ...
            children: /* @__PURE__ */ jsx2(Reveal, { ...props, children: node2.props.children })
          }
        ) });
      case "li":
  ...
  return matchIf(
    () => /* @__PURE__ */ jsx2(
      "div",
      {
        ...
        children: children.split("").map((char2, index) => /* @__PURE__ */ jsx2(
          "span",
          {
            css: matchIfOrNull(() => animationStyles)(inView),
            style: {
...
var Fade = (props) => {
  ...
  return /* @__PURE__ */ jsx2(Reveal, { keyframes: keyframes3, ...rest });
};
var flip = keyframes`
  from {
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-OXGF3ABJ.js.map
