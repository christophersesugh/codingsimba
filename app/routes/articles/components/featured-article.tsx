  ...
  return (
    <div className="mb-12">
      <Link
        ...
        prefetch="intent"
      >
        <div className="grid max-h-[330px] items-center gap-8 overflow-hidden rounded-2xl bg-gray-100 md:grid-cols-2 dark:bg-gray-900">
          <div className="relative aspect-video md:aspect-auto md:h-full">
            <img
              src={article.image}
              alt={article.title}
              className="h-full min-h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"
            />
