---
  ...
  photo: https://res.cloudinary.com/christo/image/upload/v1714745993/buffers_ayjtfg.avif
  description: A comprehensive guide to understanding Buffers in NodeJs
  video: 
